...
const Game = () => {
    ...
    const [idToOpenMap, setIdToOpenMap] = useState({"A1":false, "B1":false, "C1":false, "D1":false, "E1":false, "F1":false, "G1":false, "H1":false, "I1":false, "J1":false, "K1":false, "L1":false, "M1":false, "N1":false, "O1":false, "P1":false, "Q1":false, "R1":false,
    ...
    const cards = {"A1":<ZebraCard id={2} key={2} letter={"A1"} enableFlip={player==nextPlayer} onFlip={onFlip} openCard={a1Open}/>,
